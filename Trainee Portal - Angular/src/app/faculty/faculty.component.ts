...
// }
  ...
  loginData2(logindata:any){
    this.ls.loginservice3NT(logindata.value).subscribe();
  }

  loginFaculty2(){
    console.log(this.faculty)
    this.ls.loginFacultyFromRemoteNT(this.faculty).subscribe(
       _data=>{
        //this.msg1='You logged in successfully';
        alert("logged in successfully");
        console.log("Successfull");
  ...
  loginData3(logindata:any){
    this.ls.loginservice3JEE(logindata.value).subscribe();
  }

  loginFaculty3(){
    console.log(this.faculty)
    this.ls.loginFacultyFromRemoteJEE(this.faculty).subscribe(
       _data=>{
        //this.msg1='You logged in successfully';
        alert("logged in successfully");
        console.log("Successfull");
