...
// }
  ...
  goToUser2(ntstudentpanel:String){
    this.router.navigate(['${ntstudentpanel}']);
  }

  loginData2(logindata:any){
    this.ls.loginservice1NT(logindata.value).subscribe();
  }

  loginUser2(){
    console.log(this.user)
    this.ls.loginUserFromRemoteNT(this.user).subscribe(
       _data=>{
        //this.msg1='You logged in successfully';
        alert("logged in successfully");
        console.log("Successfull");
  ...
  loginData3(logindata:any){
    this.ls.loginservice1JEE(logindata.value).subscribe();
  }

  loginUser3(){
    console.log(this.user)
    this.ls.loginUserFromRemoteJEE(this.user).subscribe(
       _data=>{
        //this.msg1='You logged in successfully';
        alert("logged in successfully");
        console.log("Successfull");
